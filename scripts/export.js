		...
		function (response) {
			...
			file.on("finish", function () {
				file.close(function () {
					...
					try {
						fs.removeSync(
							`./Release/com.acme.my-streamdeck-plugin.streamDeckPlugin`
						);
						let distributionCommand = `${currentPlatform.distributionToolFilename} -b -i ./build/com.acme.myStreamdeckPlugin.sdPlugin -o ./Release`;
						if (os.platform() !== "win32") {
