...
async function connected(jsn) {
	...
	$SD.on(
		"com.acme.myStreamdeckPlugin.action.willAppear",
		jsonObj => action.onWillAppear(jsonObj)
	);
	$SD.on(
		"com.acme.myStreamdeckPlugin.action.keyUp",
		jsonObj => action.onKeyUp(jsonObj)
	);
	$SD.on(
		"com.acme.myStreamdeckPlugin.action.sendToPlugin",
		jsonObj => action.onSendToPlugin(jsonObj)
	);
	$SD.on(
		"com.acme.myStreamdeckPlugin.action.didReceiveSettings",
